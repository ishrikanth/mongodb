Feature: Manage People
  ...
  Scenario: Given valid Person
    ...
    And I fill in the "First Name" with "cucumber3"
    And I fill in the "Last Name" with "cucumber last name 3"
    And I fill in the "email" with "cucumber@cucmber.com"
    And I fill in the "notes" with "cucumber mongo_test"
